...
s1=$(cat qtd_num1 | sort -h | tail -n 1 | cut -d " " -f6) #qtd
s2=$(cat qtd_num1 | sort -h | tail -n 1 | cut -d " " -f7) #numero
...
s1=$(cat qtd_num2 | sort -h | tail -n 1 | cut -d " " -f6) #qtd
s2=$(cat qtd_num2 | sort -h | tail -n 1 | cut -d " " -f7) #numero
...
s1=$(cat qtd_num3 | sort -h | tail -n 1 | cut -d " " -f6) #qtd
s2=$(cat qtd_num3 | sort -h | tail -n 1 | cut -d " " -f7) #numero
...
s1=$(cat qtd_num4 | sort -h | tail -n 1 | cut -d " " -f6) #qtd
s2=$(cat qtd_num4 | sort -h | tail -n 1 | cut -d " " -f7) #numero
...
s1=$(cat qtd_num5 | sort -h | tail -n 1 | cut -d " " -f6) #qtd
s2=$(cat qtd_num5 | sort -h | tail -n 1 | cut -d " " -f7) #numero
...
s1=$(cat qtd_num6 | sort -h | tail -n 1 | cut -d " " -f6) #qtd
s2=$(cat qtd_num6 | sort -h | tail -n 1 | cut -d " " -f7) #numero
